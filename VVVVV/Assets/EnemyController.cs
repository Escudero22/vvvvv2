...
public class EnemyController : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        //    Invoke("ResumeMovement", 1.5f); // Cambia el valor 1.5f al tiempo que necesites para la animación de ataque.
        //}
    }
    ...
    void ResumeMovement()
    {
        ...
        moveSpeed = 5f; // Ajusta la velocidad de movimiento según tu juego
    }
